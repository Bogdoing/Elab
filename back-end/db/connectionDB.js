...
module.exports = {
	...
	updateUserBalanse: async function(amount_acc, adress){ 
		...
		[amount_acc, adress],
		function (error, results, fields) {
			if (error) console.log('throw error + updateUserBalanse');
			else console.log('connDB UpdateUserBalanse OK');
		});
	},

	updateUserBalanseMinus: async function(amount_acc, adress){ 
